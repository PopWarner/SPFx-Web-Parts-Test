...
export default class DynamicBundlingExampleWebPart extends BaseClientSideWebPart<IDynamicBundlingExampleWebPartProps> {
  ...
  // This will create the 'DynamicImportedFunctions.ts' to be bundled into a separate .js file.
  ...
  //This will create the 'DynamicImportedFunctionsJQuery.ts' to be bundled into a separate .js file.
